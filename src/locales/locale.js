export const CONTENT = {
    ...
    pt: {
        ...
        itinerary: {
            ...
            tabs: ["Dias de Aquecimento", "O dia do Casamento", "O dia da Ressaca"],
            events: {
                pre: [
                    { time: "Quarta - 19:00", title: "Jantar de Boas-vindas", desc: "Vamos adorar encontrar os que vão chegar antes e suas famílias para um jantar de recepção e início oficial das comemorações.", badge: "Condominio Vila Mar", color: "secondary" },
                    { time: "Quinta - 10:00", title: "Axé Moi", desc: "Prepare-se para vivenciar o que Porto Seguro tem de mais único, prepare as coreografias e a energia para um dia memoravel!", badge: "Barraca Axé Moi", color: "highlight" },
