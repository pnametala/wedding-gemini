...
export const RSVPPage = ({t, lang}) => {
    ...
    return (
        <div
            className="max-w-5xl mx-auto px-6 pt-48 min-h-screen animate-[fade-in_1s_ease-out]">
            ...
            {errorMsg !== '' && (
                <div className="text-center py-8">
                    <p className="mt-4 text-sm ">{errorMsg}</p>
                    <button
                        onClick={() => setStep('form')}
                        className="w-32 bg-[var(--color-secondary)] text-white py-3 rounded-full font-bold mt-4 hover:opacity-90">
                        {t.backBtn}
                                    ...
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <input required type="text" value={form.dietaryRequirementsPlusOne}
                                                   onChange={(e) => setForm({
                                                       ...form,
                                                       dietaryRequirementsPlusOne: e.target.value
                                                   })}
                                                   className="w-full p-3 rounded-xl border-2 border-gray-200 bg-white"/>
                                        </div>
                                    </>
