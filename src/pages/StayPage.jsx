...
export const StayPage = ({ t, lang }) => {
    const info = {
        "pt-BR": {
            intro1: <>O casamento será no <b>Hotel Solar do Imperador</b>, que é perto do centro da cidade de Porto Seguro, passarela da cultura, aeroporto e rodoviária. Porém, os eventos de aquecimento e principais atividades para fazer durante o dia ficam perto da praia de Taperapuã.</>,
            intro2: <>Se a sua prentensão é ficar <b>mais de 3 dias</b>, nossa recomendação é que voce se hospede mais <b>perto da praia.</b></>,
            intro3: <>Mas caso a sua <b>estadia</b> seja <b>mais curta, o hotel provavelmente será mais conveniente.</b></>,
            ...
            hotels: [
                {
                    name: "1. Porto Geraes Praia Hotel",
                    ...
                    extra: "O link só funciona dentro do Brasil, então se você estiver fora e não tiver VPN, contacte o hotel direto pela whatsapp [+55 73 99162255] mencionando o casamento, e/ou fale com os noivos que eles vão poder ajudar"
                },
                {
                    name: "2. Condomínio Vila Mar",
                ...
                {
                    name: "3. Hotel Solar do Imperador",
        ...
        "en-AU": {
            intro1: <>The wedding will be at <b>Hotel Solar do Imperador</b>, which is near the city centre, the "Passarela da Cultura," the airport, and the bus station. However, the warm-up events and main daytime activities are located near Taperapuã Beach.</>,
            intro2: <>If you're planning on staying for <b>more than 3 days</b>, we recommend staying <b>closer to the beach.</b></>,
            ...
            hotels: [
                {
                    ...
                    extra: "The discount link only works within Brazil. If you're overseas without a VPN, please contact the hotel directly via WhatsApp [+55 73 99162255] mentioning the wedding, or give us a shout and we'll help you out."
                },
                {
                    name: "2. Condomínio Vila Mar",
        ...
        <div className="max-w-5xl mx-auto px-6 py-24 min-h-screen animate-[fade-in_1s_ease-out]">
            ...
            <div className="grid md:grid-cols-1 mt-8">
                {s.hotels.map((hotel, index) => (
                    <div key={index} className="bg-white p-6 rounded-[15px] mb-4 border-l-4 border-[var(--color-muted)] shadow-sm">
                        ...
                        <div className="mt-3">
                            ...
                            <ul className="mt-1">
                                ...
                                {hotel.preTime && <li className="text-sm text-gray-500"><b>Pre-wedding (Barraca da Jinga):</b> {hotel.preTime}</li>}
                            </ul>
                        </div>

                        <p className="text-sm text-gray-500 font-bold mt-5">{s.discount} 
                            <a className='ml-1 text-[var(--color-secondary)]' href={index === 0 ? "https://sbreserva.silbeck.com.br/portogeraes/pt-br/reserva/busca/?checkin=2026-09-18&checkout=2026-09-20&adultos-000001=1&promo=RAISSA" : "#"}>Link</a>
                        </p>
                        ...
                        {index !== 1 && (
                            <>
                                <p className="text-sm text-gray-500 font-bold mt-5">{s.booking} 
                                    <a className='ml-1 text-[var(--color-secondary)]' href={index === 0 ? "https://www.booking.com/Share-Ii6PMe0" : "https://www.booking.com/Share-cCmOVg1"}>Link</a>
                                </p>
